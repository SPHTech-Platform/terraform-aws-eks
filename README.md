...
| <a name="input_additional_karpenter_security_group_selector_tags"></a> [additional\_karpenter\_security\_group\_selector\_tags](#input\_additional\_karpenter\_security\_group\_selector\_tags) | Additional security group tags to add to the Karpenter node groups | `map(string)` | `{}` | no |
...
| <a name="input_enable_cluster_windows_support"></a> [enable\_cluster\_windows\_support](#input\_enable\_cluster\_windows\_support) | Enable Windows support for the cluster | `bool` | `false` | no |
