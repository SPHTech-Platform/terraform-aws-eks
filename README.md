...
| <a name="input_subnet_selector_name_tag"></a> [subnet\_selector\_name\_tag](#input\_subnet\_selector\_name\_tag) | Subnet selector Name tags for Karpenter nodes, supports wildcard. | `string` | n/a | yes |
