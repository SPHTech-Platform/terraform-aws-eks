...
| <a name="input_install_crds_first"></a> [install\_crds\_first](#input\_install\_crds\_first) | Allow installation of CRDs first and skip Custom Resource creations | `bool` | `true` | no |
