...
| <a name="enable_cluster_windows_support"></a> [enable\_cluster\_windows\_support](#input\_enable\_cluster\_\windows\_support) | Determines whether to enabledd windows support to the cluster by updating the aws-auth configmap and creating amazon-vpc-cni windows support | `bool` | `true` | no |
