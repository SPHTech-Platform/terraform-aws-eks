locals {
  ...
  additional_aws_auth_fargate_profile_pod_execution_role_arns = var.autoscaling_mode == "karpenter" && !var.install_crds_first ? values(module.karpenter.fargate_profile_pod_execution_role_arn) : []
