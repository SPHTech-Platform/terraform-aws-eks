...
| <a name="module_node_termination_handler_irsa"></a> [node\_termination\_handler\_irsa](#module\_node\_termination\_handler\_irsa) | terraform-aws-modules/iam/aws//modules/iam-role-for-service-accounts | ~> 6.4.0 |
| <a name="module_node_termination_handler_sqs"></a> [node\_termination\_handler\_sqs](#module\_node\_termination\_handler\_sqs) | terraform-aws-modules/sqs/aws | ~> 5.2.0 |
...
| [kubernetes_cron_job_v1.scale_down_keda](https://registry.terraform.io/providers/hashicorp/kubernetes/latest/docs/resources/cron_job_v1) | resource |
| [kubernetes_cron_job_v1.scale_up_keda](https://registry.terraform.io/providers/hashicorp/kubernetes/latest/docs/resources/cron_job_v1) | resource |
| [kubernetes_manifest.system_scaled_objects](https://registry.terraform.io/providers/hashicorp/kubernetes/latest/docs/resources/manifest) | resource |
...
| [kubernetes_role_binding_v1.keda_scaler](https://registry.terraform.io/providers/hashicorp/kubernetes/latest/docs/resources/role_binding_v1) | resource |
| [kubernetes_role_v1.keda_scaler](https://registry.terraform.io/providers/hashicorp/kubernetes/latest/docs/resources/role_v1) | resource |
| [kubernetes_service_account_v1.keda_scaler](https://registry.terraform.io/providers/hashicorp/kubernetes/latest/docs/resources/service_account_v1) | resource |
...
| <a name="input_brupop_chart_version"></a> [brupop\_chart\_version](#input\_brupop\_chart\_version) | Chart version for brupop | `string` | `"1.8.0"` | no |
...
| <a name="input_brupop_tag"></a> [brupop\_tag](#input\_brupop\_tag) | Docker image tag for brupop. This should correspond to the Kubernetes version | `string` | `"v1.8.0"` | no |
...
| <a name="input_cert_manager_chart_version"></a> [cert\_manager\_chart\_version](#input\_cert\_manager\_chart\_version) | Version of Chart to install. Set to empty to install the latest version | `string` | `"v1.20.2"` | no |
...
| <a name="input_cluster_autoscaler_chart_version"></a> [cluster\_autoscaler\_chart\_version](#input\_cluster\_autoscaler\_chart\_version) | Chart version for Cluster Autoscaler | `string` | `"9.56.0"` | no |
...
| <a name="input_cluster_autoscaler_tag"></a> [cluster\_autoscaler\_tag](#input\_cluster\_autoscaler\_tag) | Docker image tag for Cluster Autoscaler. This should correspond to the Kubernetes version | `string` | `"v1.34.1"` | no |
...
| <a name="input_fluent_bit_helm_config_defaults"></a> [fluent\_bit\_helm\_config\_defaults](#input\_fluent\_bit\_helm\_config\_defaults) | Helm provider default config for Fluent Bit. | `any` | <pre>{<br/>  "chart": "fluent-bit",<br/>  "description": "Fluent Bit helm Chart deployment configuration",<br/>  "name": "fluent-bit",<br/>  "namespace": "logging",<br/>  "repository": "https://fluent.github.io/helm-charts",<br/>  "version": "0.57.3"<br/>}</pre> | no |
...
| <a name="input_fluent_bit_image_tag"></a> [fluent\_bit\_image\_tag](#input\_fluent\_bit\_image\_tag) | Fluent Bit Image tag | `string` | `"2.34.1"` | no |
...
| <a name="input_fluent_bit_readiness_probe"></a> [fluent\_bit\_readiness\_probe](#input\_fluent\_bit\_readiness\_probe) | Readiness probe for fluent-bit | `map(any)` | <pre>{<br/>  "httpGet": {<br/>    "path": "/api/v2/health",<br/>    "port": 2020<br/>  }<br/>}</pre> | no |
...
| <a name="input_keda_scaling_enabled"></a> [keda\_scaling\_enabled](#input\_keda\_scaling\_enabled) | Whether to enable scaling for KEDA operator and metric server. This is required when KEDA is enabled and it's not production environment | `bool` | `true` | no |
| <a name="input_keda_scaling_timezone"></a> [keda\_scaling\_timezone](#input\_keda\_scaling\_timezone) | Timezone for scaling, required if scaling is enabled for KEDA operator and metric server | `string` | `"Asia/Singapore"` | no |
| <a name="input_keda_self_scale_down_schedule"></a> [keda\_self\_scale\_down\_schedule](#input\_keda\_self\_scale\_down\_schedule) | Cron expression for self scale down, required if scaling is enabled for KEDA operator and metric server | `string` | `"0 21 * * 1-5"` | no |
| <a name="input_keda_self_scale_up_schedule"></a> [keda\_self\_scale\_up\_schedule](#input\_keda\_self\_scale\_up\_schedule) | Cron expression for self scale up, required if scaling is enabled for KEDA operator and metric server | `string` | `"30 7 * * 1-5"` | no |
...
| <a name="input_kube_state_metrics_helm_config_defaults"></a> [kube\_state\_metrics\_helm\_config\_defaults](#input\_kube\_state\_metrics\_helm\_config\_defaults) | Helm provider default config for kube-state-metrics. | `any` | <pre>{<br/>  "chart": "kube-state-metrics",<br/>  "description": "kube-state-metrics helm Chart deployment configuration",<br/>  "name": "kube-state-metrics",<br/>  "namespace": "kube-system",<br/>  "repository": "https://prometheus-community.github.io/helm-charts",<br/>  "version": "7.2.2"<br/>}</pre> | no |
...
| <a name="input_node_exporter_helm_config_defaults"></a> [node\_exporter\_helm\_config\_defaults](#input\_node\_exporter\_helm\_config\_defaults) | Helm provider default config for prometheus-node-exporter. | `any` | <pre>{<br/>  "chart": "prometheus-node-exporter",<br/>  "description": "prometheus-node-exporter helm Chart deployment configuration",<br/>  "name": "prometheus-node-exporter",<br/>  "namespace": "kube-system",<br/>  "repository": "https://prometheus-community.github.io/helm-charts",<br/>  "version": "4.53.1"<br/>}</pre> | no |
...
| <a name="input_nodelocaldns_affinity"></a> [nodelocaldns\_affinity](#input\_nodelocaldns\_affinity) | Node Local DNS Cache affinity | `map(any)` | <pre>{<br/>  "nodeAffinity": {<br/>    "requiredDuringSchedulingIgnoredDuringExecution": {<br/>      "nodeSelectorTerms": [<br/>        {<br/>          "matchExpressions": [<br/>            {<br/>              "key": "kubernetes.io/os",<br/>              "operator": "In",<br/>              "values": [<br/>                "linux"<br/>              ]<br/>            },<br/>            {<br/>              "key": "kubernetes.io/arch",<br/>              "operator": "In",<br/>              "values": [<br/>                "amd64",<br/>                "arm64"<br/>              ]<br/>            },<br/>            {<br/>              "key": "eks.amazonaws.com/compute-type",<br/>              "operator": "NotIn",<br/>              "values": [<br/>                "fargate",<br/>                "auto"<br/>              ]<br/>            }<br/>          ]<br/>        }<br/>      ]<br/>    }<br/>  }<br/>}</pre> | no |
| <a name="input_nodelocaldns_cache_prefetch_enabled"></a> [nodelocaldns\_cache\_prefetch\_enabled](#input\_nodelocaldns\_cache\_prefetch\_enabled) | Enable cache prefetching | `bool` | `false` | no |
| <a name="input_nodelocaldns_chart_name"></a> [nodelocaldns\_chart\_name](#input\_nodelocaldns\_chart\_name) | Chart name for Node Local DNS Cache | `string` | `"node-local-dns"` | no |
| <a name="input_nodelocaldns_chart_repository"></a> [nodelocaldns\_chart\_repository](#input\_nodelocaldns\_chart\_repository) | Chart Repository URL for Node Local DNS Cache | `string` | `"oci://ghcr.io/deliveryhero/helm-charts"` | no |
| <a name="input_nodelocaldns_chart_version"></a> [nodelocaldns\_chart\_version](#input\_nodelocaldns\_chart\_version) | Chart version for Node Local DNS Cache | `string` | `"2.7.0"` | no |
| <a name="input_nodelocaldns_custom_upstream_svc_name"></a> [nodelocaldns\_custom\_upstream\_svc\_name](#input\_nodelocaldns\_custom\_upstream\_svc\_name) | Custom upstream service name | `string` | `""` | no |
| <a name="input_nodelocaldns_enable_logging"></a> [nodelocaldns\_enable\_logging](#input\_nodelocaldns\_enable\_logging) | Enable logging for Node Local DNS Cache | `bool` | `false` | no |
| <a name="input_nodelocaldns_enabled"></a> [nodelocaldns\_enabled](#input\_nodelocaldns\_enabled) | Enable Node Local DNS Cache | `bool` | `false` | no |
| <a name="input_nodelocaldns_image_pull_secrets"></a> [nodelocaldns\_image\_pull\_secrets](#input\_nodelocaldns\_image\_pull\_secrets) | Image pull secrets for Node Local DNS Cache | `list(any)` | `[]` | no |
| <a name="input_nodelocaldns_image_repository"></a> [nodelocaldns\_image\_repository](#input\_nodelocaldns\_image\_repository) | Node Local DNS Cache image repository | `string` | `"registry.k8s.io/dns/k8s-dns-node-cache"` | no |
| <a name="input_nodelocaldns_image_tag"></a> [nodelocaldns\_image\_tag](#input\_nodelocaldns\_image\_tag) | Node Local DNS Cache image tag, Refer https://github.com/kubernetes/dns/releases to get tag | `string` | `"1.26.0"` | no |
| <a name="input_nodelocaldns_internal_domain_name"></a> [nodelocaldns\_internal\_domain\_name](#input\_nodelocaldns\_internal\_domain\_name) | Node Local DNS Cache internal domain name | `string` | `"cluster.local"` | no |
...
| <a name="input_nodelocaldns_setup_iptables"></a> [nodelocaldns\_setup\_iptables](#input\_nodelocaldns\_setup\_iptables) | Setup iptables for Node Local DNS Cache | `bool` | `true` | no |
| <a name="input_nodelocaldns_skip_teardown"></a> [nodelocaldns\_skip\_teardown](#input\_nodelocaldns\_skip\_teardown) | Skip teardown for Node Local DNS Cache | `bool` | `false` | no |
