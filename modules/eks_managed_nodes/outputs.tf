...
output "node_group_autoscaling_group_names" {
  ...
  value       = values(module.eks_managed_node_group)[*].node_group_autoscaling_group_names
}

output "node_group_status" {
  description = "Status of the EKS Node Group"
  value       = values(module.eks_managed_node_group)[*].node_group_status
}
...
output "node_group_taints" {
  ...
  value       = values(module.eks_managed_node_group)[*].node_group_taints
}
