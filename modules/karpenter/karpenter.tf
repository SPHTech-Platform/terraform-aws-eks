...
module "karpenter-crds" {
  ...
  crds_urls = [
    "https://raw.githubusercontent.com/aws/karpenter/v${var.karpenter_chart_version}/charts/karpenter/crds/karpenter.sh_provisioners.yaml",
    "https://raw.githubusercontent.com/aws/karpenter/v${var.karpenter_chart_version}/charts/karpenter/crds/karpenter.k8s.aws_awsnodetemplates.yaml",
    "https://raw.githubusercontent.com/aws/karpenter/v${var.karpenter_chart_version}/charts/karpenter/crds/karpenter.sh_machines.yaml",
  ]
}
